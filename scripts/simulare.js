...
var VERSIUNEA_1 = 0;
var VERSIUNEA_2 = 1;
var VERSIUNEA_SELECTATA = VERSIUNEA_2;
...
//v2
var PROCENT_DISTRIBUTIE_MASCA_V2 = 0.4;
var PROCENT_DISTRIBUTIE_ACASA_V2 = 0.1;
var PROCENT_DISTRIBUTIE_AFARA_V2 = 1 - PROCENT_DISTRIBUTIE_MASCA - PROCENT_DISTRIBUTIE_ACASA;

//distributie metoda protectie de start
var PROCENT_DISTRIBUTIE_MASCA_DE_START = 0.1;
var PROCENT_DISTRIBUTIE_ACASA_DE_START = 0;
var PROCENT_DISTRIBUTIE_AFARA_DE_START = 1 - PROCENT_DISTRIBUTIE_MASCA_DE_START - PROCENT_DISTRIBUTIE_ACASA_DE_START;
...
var RAZA_CERC_METODA_PROTECTIE_MASCA = 7;
var GROSIME_LINIE_METODA_PROTECTIE_MASCA = 12;
...
var TEXT_TITLU = TEXT_TITLU_RO;
var TEXT_ZILE_TRECUTE = TEXT_ZILE_TRECUTE_RO;
var TEXT_LEGENDA_FRUNZE_NORMALE = TEXT_LEGENDA_FRUNZE_NORMALE_RO;
var TEXT_LEGENDA_FRUNZE_PATRUNSE = TEXT_LEGENDA_FRUNZE_PATRUNSE_RO;
var TEXT_LEGENDA_FRUNZE_VINDECATE = TEXT_LEGENDA_FRUNZE_VINDECATE_RO;
var TEXT_LEGENDA_FRUNZE_PIERDUTE = TEXT_LEGENDA_FRUNZE_PIERDUTE_RO;
var TEXT_LEGENDA_MASCA = TEXT_LEGENDA_MASCA_RO;
var TEXT_LEGENDA_ACASA = TEXT_LEGENDA_ACASA_RO;
...
function asignare_metoda_preventie_de_start(){
    ...
    for(let i=3; i<vector_jetoane.length; i++){
        //var idx = Math.floor(Math.random() * distributieAlegereMetodaPreventie.length);
        //metoda_preventie_random = distributieAlegereMetodaPreventie[idx];

        proc_acasa = Math.floor(PROCENT_DISTRIBUTIE_ACASA_DE_START * 100) / 100;
        proc_masca = Math.floor(PROCENT_DISTRIBUTIE_MASCA_DE_START * 100) / 100;
        proc_afara = Math.floor(PROCENT_DISTRIBUTIE_AFARA_DE_START * 100) / 100;
...
function setare_procente_protectii_preferate(){
    if(VERSIUNEA_SELECTATA == VERSIUNEA_2){
        if(!localStorage.getItem('mask_percentage_v2')) {
            localStorage.setItem('mask_percentage_v2', PROCENT_DISTRIBUTIE_MASCA_V2);
        } else {
          PROCENT_DISTRIBUTIE_MASCA_V2 = parseFloat(localStorage.getItem('mask_percentage_v2'));
        }

        if(!localStorage.getItem('home_percentage_v2')) {
            localStorage.setItem('home_percentage_v2', PROCENT_DISTRIBUTIE_ACASA_V2);
        } else {
          PROCENT_DISTRIBUTIE_ACASA_V2 = parseFloat(localStorage.getItem('home_percentage_v2'));
        }
        ...
        //setare procente conform datelor salvate
